<%@ Page Title="" Language="C#" MasterPageFile="~/Default2.master" AutoEventWireup="true" CodeFile="readfb.aspx.cs" Inherits="readfb" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server" BackImageUrl="~/Images/BK.jpg" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            <SelectParameters>
                <asp:Parameter DefaultValue="READ" Name="Status" Type="String" />
            </SelectParameters>
            <UpdateParameters>
                <asp:Parameter Name="Name" Type="String" />
                <asp:Parameter Name="Feedback" Type="String" />
        ...
        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" 
            ...
            DataSourceID="SqlDataSource1" style="margin-left: 297px" Width="807px">
            <Columns>
