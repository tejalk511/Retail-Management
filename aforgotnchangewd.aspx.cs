...
public partial class aforgotnchangewd : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("select UserName,Password,SecurityQues,SecurityAns from Admin where UserName = @name", con);
    ...
    protected void Button4_Click(object sender, EventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["RConnectionString"].ConnectionString);
        con.Open();
        SqlCommand cmd1 = new SqlCommand("select Password,SecurityQues,SecurityAns from Admin where UserName = @name", con);
