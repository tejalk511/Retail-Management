<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="alogin.aspx.cs" Inherits="alogin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    <p>
        ...
        <asp:Panel ID="Panel2" runat="server" BackColor="#FF66FF" Height="396px" 
            ...
            <br />
            <asp:Label ID="Label5" runat="server" Text="Admin Login"></asp:Label>
            <br />
            <br />
            ...
            <asp:HyperLink ID="HyperLink2" runat="server" ForeColor="Blue" 
                NavigateUrl="~/aforgotnchangewd.aspx">Forgot Password ?</asp:HyperLink>
        </asp:Panel>
        <br />
        <br />
        <br />
